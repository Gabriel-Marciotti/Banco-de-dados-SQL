...
-- Utilizamos o where true pela obrigatoriedade do where e principalmente pelo fato de que queremos inserir em todas as linhas, então o where true fará isso
