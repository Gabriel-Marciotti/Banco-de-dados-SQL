...
-- sempre utilizar parênteses para operar com select
...
-- Isso porque count(*) vira uma coluna com valores específicos, então podemos operar seus números como em outros casos de tabelas